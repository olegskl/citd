...
export class SocketProvider extends React.PureComponent<{}, ISocketProviderState> {
  ...
  private readonly api: ISocketContext['socket'] = {
    ...
    off: (eventName, callback) => {
      if (!this.messageHandlers[eventName]) { return; }
  ...
  render() {
    ...
    return (
      <SocketContext.Provider value={this.api}>
        {this.props.children}
